...
const food = [
    ...
    { name: 'Cinnabon Cinnamon roll', cals: 880, img: "https://us.123rf.com/450wm/slowcentury/slowcentury1412/slowcentury141200001/34422820-stock-vector-freshly-baked-cinnamon-roll-with-sweet-frosting-vector-illustration-.jpg?ver=6", id: 8 },
    { name: '32 oz Coca-Cola', cals: 310, img: "https://i.pinimg.com/originals/13/b4/81/13b481fbb96d856d2b09d410da695f55.png", id: 9 },
    { name: 'Carmel Frappuccino', cals: 420, img: "https://s1.r29static.com//bin/entry/d2d/600x900,80/1457128/image.jpg", id: 10 }
];

let modifiedFood = food.slice()
...
module.exports = {
    ...
    addToPlate: (req, res) => {
        let foodObj = food.filter(val => val.id == req.params.id)
        yourPlate = [...yourPlate, foodObj[0]]
